...
final class TextRecognitionTestSuite: XCTestCase {
    ...
    func testFullOCRPipelineIntegration() throws {
        ...
        let textRecognitionManager = testContainer.resolve(VisionTextRecognitionProtocol.self)
        let imageClassificationManager = testContainer.resolve(ImageClassificationProtocol.self)
